...
class AccountMove(models.Model):
    ...
    vorlauf_id = fields.Many2one('ecofi', 'Export', readonly=True, ondelete='set null', copy=False)
...
class account_invoice(models.Model):
    ...
    vorlauf_id = fields.Many2one('ecofi', 'Export', copy=False, ondelete='set null', index=2)
    ...
    def _onchange_partner_id(self):
        ...
        if p:
            if p.parent_id:
                ...
                pa = p
            rec_account = pa.property_account_receivable_id
            pay_account = pa.property_account_payable_id
