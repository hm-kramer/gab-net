...
class ResCompany(models.Model):
    ...
    account_code_digits = fields.Integer('Account Code Digits', default=4)
    remove_leading_zeros = fields.Boolean('Remove Leading Zeros', help='Removes leading Zeros on Account-Codes. E.g. 0670 becomes 670 in the Export.')
